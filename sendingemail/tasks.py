...
def send_department_emails(self, department):
    ...
    subject = f"Important Update for {department} Department"
    html_message = render_to_string('email_template.html', {'department': department})
